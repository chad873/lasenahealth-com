    ...
    <div className="bg-white">
      <div className="bg-[#f4f9f7] border-b border-green-100 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-lg max-w-2xl leading-relaxed">Understanding what happens when hospice care begins can bring peace of mind. Lumen will write the full content here.</p>
        </div>
      </div>
