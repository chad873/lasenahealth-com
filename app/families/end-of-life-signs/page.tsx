    ...
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-10">
        ...
        <div className="bg-[#f5f4f0] border border-stone-300 rounded p-6">
          ...
          <a href="tel:+18005551234" className="inline-block mt-4 bg-[#7A8066] text-white px-5 py-2 text-sm font-semibold rounded hover:bg-[#5e6350] transition-colors">📞 (800) 555-1234</a>
        </div>

        <div className="pt-4 border-t border-gray-100 flex flex-wrap gap-4">
          <Link href="/families/grief-and-bereavement" className="text-[#7A8066] text-sm font-medium hover:underline">Next: Grief & Bereavement →</Link>
