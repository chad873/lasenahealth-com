    ...
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-10">
        ...
        <div className="bg-[#7A8066] text-white rounded p-8">
          ...
          <a href="tel:+18005551234" className="inline-block bg-white text-[#7A8066] px-5 py-2 text-sm font-semibold rounded hover:bg-stone-50 transition-colors">📞 Talk to our team</a>
        </div>

        <div className="pt-4 border-t border-gray-100 flex flex-wrap gap-4">
          <Link href="/families/end-of-life-signs" className="text-[#7A8066] text-sm font-medium hover:underline">Next: End-of-Life Signs →</Link>
