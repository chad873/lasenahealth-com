...
export default function Page() {
  return (
    <div className="bg-white">
      <div className="bg-[#2e7d5e] py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-green-200 text-xs uppercase tracking-widest mb-3 font-medium">Healthcare Professionals</p>
          <h1 className="font-serif text-4xl font-bold text-white mb-4" style={{ color: "white" }}>Hospice Eligibility Guidelines</h1>
          <p className="text-green-100 text-lg max-w-2xl leading-relaxed">A clinical reference for physicians and other referring providers.</p>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-10">
        ...
        <div className="bg-gray-900 text-white rounded p-8">
          ...
          <a href="tel:+18005551234" className="inline-block bg-[#2e7d5e] text-white px-5 py-2 text-sm font-semibold rounded hover:bg-[#245f49] transition-colors">📞 (800) 555-1234</a>
        </div>

        <div className="pt-4 border-t border-gray-100 flex flex-wrap gap-4">
          <Link href="/professionals/medicare-benefit" className="text-[#2e7d5e] text-sm font-medium hover:underline">Next: Medicare Hospice Benefit →</Link>
