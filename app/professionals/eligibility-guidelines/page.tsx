    ...
    <div className="bg-white">
      <div className="bg-[#f4f9f7] border-b border-green-100 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-4xl font-bold text-gray-800 mb-4">Hospice Eligibility Guidelines</h1>
          <p className="text-gray-600 text-lg max-w-2xl leading-relaxed">A patient is eligible for hospice care when a physician certifies a prognosis of six months or less if the illness runs its expected course. Lumen will write the full content here.</p>
        </div>
      </div>
