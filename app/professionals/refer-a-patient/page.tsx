        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="date" className="w-full border border-gray-300 px-4 py-3 text-sm rounded focus:outline-none focus:border-[#2e7d5e]" />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea rows={4} className="w-full border border-gray-300 px-4 py-3 text-sm rounded focus:outline-none focus:border-[#2e7d5e]" placeholder="Urgency, insurance info, family contact, other relevant details..." />
          </div>
