    ...
    <div className="bg-white">
      <div className="bg-[#f4f9f7] border-b border-green-100 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#2e7d5e] text-xs uppercase tracking-widest mb-3 font-medium">Careers</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="border-t border-gray-200 pt-10">
          ...
          <a href="mailto:jobs@lasenahealth.com" className="inline-block bg-[#2e7d5e] text-white px-6 py-3 text-sm font-semibold rounded hover:bg-[#245f49] transition-colors">Apply Now →</a>
        </div>
