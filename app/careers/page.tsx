    ...
    <div className="bg-white">
      <div className="bg-[#f4f9f7] border-b border-green-100 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-4xl font-bold text-gray-800 mb-4">Careers at Lasena Health</h1>
          <p className="text-gray-600 text-lg max-w-2xl leading-relaxed">Join a team that shows up for patients and families during life's most profound moments. Lumen will write the full content here.</p>
        </div>
      </div>
