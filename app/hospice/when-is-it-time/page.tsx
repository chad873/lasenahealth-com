    ...
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <ul className="space-y-4 mb-10">
          {[
            ...
            <li key={item} className="flex items-start gap-3">
              <span className="text-[#7A8066] mt-1 text-lg">•</span>
              <span className="text-gray-700">{item}</span>
            </li>
          ))}
        </ul>

        <div className="bg-[#7A8066] text-white rounded p-8 mb-10">
          <h2 className="font-serif text-2xl font-bold mb-3" style={{ color: "white" }}>Not sure? Just call us.</h2>
          <p className="text-stone-200 leading-relaxed mb-4">If you're unsure, call us. There's no obligation — we'll help you figure out whether hospice is right for your family right now.</p>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-wrap gap-4">
          <Link href="/hospice/levels-of-care" className="text-[#7A8066] text-sm font-medium hover:underline">Next: Levels of Hospice Care →</Link>
