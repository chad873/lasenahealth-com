  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 prose prose-lg prose-gray max-w-none">
        ...
        <div className="bg-[#f4f9f7] border border-green-200 rounded p-6 my-8 not-prose">
          ...
          <a href="tel:+18005551234" className="inline-block bg-[#2e7d5e] text-white px-5 py-2 text-sm font-medium rounded hover:bg-[#245f49] transition-colors">📞 (800) 555-1234</a>
        </div>

        <div className="pt-8 border-t border-gray-100 not-prose flex flex-wrap gap-4">
          <Link href="/hospice/when-is-it-time" className="text-[#2e7d5e] text-sm font-medium hover:underline">Next: When Is It Time for Hospice? →</Link>
