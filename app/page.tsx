...
const audiences = [
  {
    ...
    icon: "🤝",
    desc: "We walk alongside you through one of life's most profound journeys — with compassion, dignity, and around-the-clock support.",
  },
  {
    title: "Healthcare Professionals",
    href: "/professionals/refer-a-patient",
    icon: "🩺",
    desc: "Refer your patients with confidence. Our team is available 24/7 to coordinate seamless transitions and exceptional clinical care.",
  },
  {
    title: "Join Our Team",
    href: "/careers",
    icon: "💙",
    desc: "If you're called to serve others at the end of life, we want to hear from you. Meaningful work, supported team, real impact.",
  },
];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-end">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pb-20 w-full">
          ...
          <h1 className="font-serif text-5xl md:text-6xl font-bold text-white leading-tight mb-6 max-w-2xl" style={{ color: "white" }}>
            Care that honors the life you've lived.
          </h1>
          <p className="text-gray-200 text-lg max-w-xl mb-10 leading-relaxed">
            Lasena Health provides compassionate, expert hospice care — so patients can live fully, and families can be present. We're here 24 hours a day, every day.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <p className="text-gray-500 mb-10">We're here for patients and families, referring physicians, and those looking to join our team.</p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-8">
              Lumen will write the full copy here. This is placeholder text to establish structure and layout.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
          <div className="relative overflow-hidden rounded group">
            ...
            />
            <div className="p-8 border border-gray-200 border-t-0 rounded-b">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-5">Guidance, support, and answers for those caring for a loved one on hospice — including what to expect, how to cope, and where to turn.</p>
      ...
      <section className="bg-gray-900 py-20 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-400 mb-8 text-lg">Call us anytime — 24 hours a day, 7 days a week.</p>
